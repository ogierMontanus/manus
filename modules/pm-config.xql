...
declare variable $pm-config:web-transform := function($xml as node()*, $parameters as map(*)?, $odd as xs:string?) {
    ...
    default return pm-andersen-web:transform($xml, $parameters)
...
declare variable $pm-config:print-transform := function($xml as node()*, $parameters as map(*)?, $odd as xs:string?) {
    ...
    default return pm-andersen-print:transform($xml, $parameters)
...
declare variable $pm-config:latex-transform := function($xml as node()*, $parameters as map(*)?, $odd as xs:string?) {
    ...
    default return pm-andersen-latex:transform($xml, $parameters)
...
declare variable $pm-config:epub-transform := function($xml as node()*, $parameters as map(*)?, $odd as xs:string?) {
    ...
    default return pm-andersen-epub:transform($xml, $parameters)
